...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=3000),
    teacher_cfg='cmhrd_configs/rfla_fcos_r50_fpn_p3_noaa_v.py',
    teacher_ckpt='work_dirs/rfla_fcos/noaa/visible-hr/epoch_12_best.pth',
    feature_distill=dict(scale_gap=1,
                         highlevel=dict(
                            type='cross',
                            weight=0.01,# with attn_weight: 1.0; without: 0.05; high_norm: 0.5
                            idx=[2,3,4]
                         ),
                         sr_feat_kd=dict(
                             weight=0.5,
