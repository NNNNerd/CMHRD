...
from .vtuav_small import VTUAVdet_S
from .noaa_seal import NOAA
from .rtdod import RTDOD
...
__all__ = [
    ...
    'Objects365V2Dataset', 'OccludedSeparatedCocoDataset', 'NOAA',
    'VTUAVdet', 'DronePerson', 'VTUAVdet_S', 'RTDOD'
]
